...
router.register(r'v1/condominios/(?P<id_condominio>.+)/contratos', ContratoCondominioSet, 'contratos')
...
router.register(r'v1/departamentos/(?P<id_departamento>.+)/lecturaServicio', LecturaServicioSet, 'lecturas')
